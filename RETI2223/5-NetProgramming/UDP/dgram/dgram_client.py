...
parser.add_option('-p', '--port',     dest="port",    default=10084, type=int, help="porta di ascolto del server" )
...
Len = s.sendto("hello from Alessandro Domenico Salvatore, in python",addr) 
