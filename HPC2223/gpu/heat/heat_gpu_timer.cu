...
///////////////////////////////
    ...
    float kernel1_total_time = 0;
    float kernel2_total_time = 0;
   ...
   for(iter=0; iter<MAX_ITER; iter=iter+1)
    ...
    fprintf (stderr,"# TIME=%.3f  #Kernel1_Total_Time=%.3f #Kernel2_Total_Time=%.3f\n", t2-t1,kernel1_total_time/1000,kernel2_total_time/1000);
